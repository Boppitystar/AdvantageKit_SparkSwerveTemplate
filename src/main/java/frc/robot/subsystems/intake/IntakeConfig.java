...
public class IntakeConfig {
  ...
  public static final class ArmConfig {
    ...
    static {
      ...
      pivotLeaderConfig.idleMode(IdleMode.kBrake).inverted(true).smartCurrentLimit(50);
      ;

      pivotFollowerConfig.idleMode(IdleMode.kBrake).inverted(false).smartCurrentLimit(50);
      ;
    }
  }
}
