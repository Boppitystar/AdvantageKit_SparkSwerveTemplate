...
public final class ShooterConfig {
  ...
  static {
    ...
    shooterLeaderConfig.smartCurrentLimit(50).idleMode(IdleMode.kCoast);
    // Follower configuration - set to follow Leader and invert
    shooterFollowerConfig.inverted(true).smartCurrentLimit(50).idleMode(IdleMode.kCoast);

    // Feeder/Kicker configuration
    shooterFeederLeaderConfig.smartCurrentLimit(50);
    shooterFeederFollowerConfig.smartCurrentLimit(50);
  }
}
